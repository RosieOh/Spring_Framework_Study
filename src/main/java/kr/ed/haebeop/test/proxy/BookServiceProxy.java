...
public class BookServiceProxy implements BookService {
    //프록시는 BookServiceImpl과 같은 구현체를 가지고 있어야 함(delegata ->)
...
//Aspect Oriented Programming = 관점 지향형 프로그래밍 : 여기 저기 다른 클래스에 흩어져 있는 메소드를 한 곳에 모아 적정한 시기가 되면, 처리될 수 있도록 모음판 역할을 하는 프로그래밍 기법
